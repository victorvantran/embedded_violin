...
USB_D-
Text Notes 14100 100  0    50   ~ 0
STM32L4X6 already includes \nan embedded pull-up resistor
Text GLabel 14900 -750 2    50   Input ~ 0
USB_D-
$Comp
L power:GND #PWR?
U 1 1 60DBFB80
P 14500 -350
F 0 "#PWR?" H 14500 -600 50  0001 C CNN
F 1 "GND" H 14505 -523 50  0000 C CNN
F 2 "" H 14500 -350 50  0001 C CNN
F 3 "" H 14500 -350 50  0001 C CNN
	1    14500 -350
	1    0    0    -1  
$EndComp
NoConn ~ 14800 -650
...
Wire Wire Line
	14500 -450 14500 -350
Text GLabel 14900 -850 2    50   Input ~ 0
USB_D+
...
U 1 1 60DBEA17
P 14500 -850
F 0 "J?" H 14557 -383 50  0000 C CNN
F 1 "USB_B_Micro" H 14557 -474 50  0000 C CNN
...
U 1 1 60DCE1FB
P 14900 -1150
F 0 "#PWR?" H 14900 -1300 50  0001 C CNN
F 1 "+5V" H 14915 -977 50  0000 C CNN
...
F 1 "+3V3" H 3215 -1427 50  0000 C CNN
...
U 1 1 60DDA9E7
P 3200 -1300
F 0 "C?" H 3292 -1254 50  0000 L CNN
F 1 "4u7" H 3292 -1345 50  0000 L CNN
...
U 1 1 60DDB37C
P 3600 -1300
F 0 "C?" H 3692 -1254 50  0000 L CNN
F 1 "100n" H 3692 -1345 50  0000 L CNN
...
U 1 1 60DDB684
P 4000 -1300
F 0 "C?" H 4092 -1254 50  0000 L CNN
F 1 "100n" H 4092 -1345 50  0000 L CNN
...
U 1 1 60DDC3E4
P 4400 -1300
F 0 "C?" H 4492 -1254 50  0000 L CNN
F 1 "100n" H 4492 -1345 50  0000 L CNN
...
U 1 1 60DDD230
P 4800 -1300
F 0 "C?" H 4892 -1254 50  0000 L CNN
F 1 "100n" H 4892 -1345 50  0000 L CNN
...
U 1 1 60DDD667
P 5200 -1300
F 0 "C?" H 5292 -1254 50  0000 L CNN
F 1 "100n" H 5292 -1345 50  0000 L CNN
...
F 1 "GND" H 3205 -1173 50  0000 C CNN
...
F 1 "27n" V 6944 -1500 50  0000 C CNN
...
U 1 1 60E06BBD
P 7050 -1300
F 0 "C?" H 7142 -1254 50  0000 L CNN
F 1 "1u" H 7142 -1345 50  0000 L CNN
...
U 1 1 60E074DC
P 7450 -1300
F 0 "C?" H 7542 -1254 50  0000 L CNN
F 1 "100n" H 7542 -1345 50  0000 L CNN
...
F 1 "GND" H 7055 -1173 50  0000 C CNN
...
F 1 "+3V3" H 6565 -1427 50  0000 C CNN
...
F 1 "+3.3VA" H 7665 -1427 50  0000 C CNN
...
F 3 "~" H 14700 1600 50  0001 C CNN
	...
	0    1    1    0   
$EndComp
Text Notes 15900 3800 0    50   ~ 0
Voltage divider to step down via \npotential divider from BUCK_IN to [1.2V, 6V)\n
$Comp
L Device:R_Small R?
U 1 1 60FCE96D
P 16200 3200
F 0 "R?" V 16004 3200 50  0000 C CNN
F 1 "100k" V 16095 3200 50  0000 C CNN
...
U 1 1 60FCF908
P 16700 3200
F 0 "R?" V 16504 3200 50  0000 C CNN
F 1 "68k" V 16595 3200 50  0000 C CNN
...
$EndComp
Wire Wire Line
	16000 3200 16100 3200
Wire Wire Line
	16300 3200 16450 3200
Wire Wire Line
...
U 1 1 60FCFACE
P 16900 3300
F 0 "#PWR?" H 16900 3050 50  0001 C CNN
F 1 "GND" H 16905 3127 50  0000 C CNN
...
$EndComp
Wire Wire Line
	16450 3200 16450 2800
Wire Wire Line
	16450 2800 16800 2800
...
U 1 1 611618C7
P 16650 -800
F 0 "U?" H 16650 -219 50  0000 C CNN
F 1 "USBLC6-2SC6" H 16650 -310 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-6" H 16650 -1300 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-2.pdf" H 16850 -450 50  0001 C CNN
	1    16650 -800
	1    0    0    -1  
$EndComp
$Comp
...
BUCK_IN
Wire Wire Line
	16800 2600 16000 2600
Wire Wire Line
	16000 2600 16000 3200
$EndSCHEMATC
